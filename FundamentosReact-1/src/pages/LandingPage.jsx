    ...
    <div className='md:flex md:min-h-screen'>
      ...
      <div className='md:w-1/4 bg-sky-900 px-5 py-10'>
        ...
        <nav className='mt-10'>
          ...
          <Link to='/zustand' className={`${urlActual === '/zustand' ? 'text-blue-300 underline' : 'text-white'} text-2xl block mt-2 hover:text-blue-200`}>6.Zustand</Link>
          
          <Link to='/rederizado' className={`${urlActual === '/rederizado' ? 'text-blue-300 underline' : 'text-white'} text-2xl block mt-2 hover:text-blue-200`}>7.Renderizado</Link>
          
          <Link to='/localstorage' className={`${urlActual === '/localstorage' ? 'text-blue-300 underline' : 'text-white'} text-2xl block mt-2 hover:text-blue-200`}>8.localStorage</Link>
